...
from core.models import GroupConv1
...
MODELNAME     =f"GroupConv_X{X_HIDDEN}{NUM_X_LAYERS}{XX_CHANNELS}_R{R_HIDDEN}{NUM_R_LAYERS}_RX{R2X_CHANNELS}_XXGC{XXGCONV_CHANNELS}{NUM_XXGCONV_LAYERS}"
